...
<experiments>
  ...
  <experiment name="experiments_5_increase_social_support" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>mean [pls] of citizens</metric>
  ...
  <experiment name="IncreaseEnforcements" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>mean [pls] of citizens</metric>
    <enumeratedValueSet variable="debug?">
